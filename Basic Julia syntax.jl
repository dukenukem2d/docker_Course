...
# ╔═╡ b7711650-1550-11eb-1603-67a810544860
begin
	c = [1 2] 
	b = [3 4]
end

# ╔═╡ 744c702c-1550-11eb-1ff6-936fc3771dfa
vcat(c, b) isa Matrix

# ╔═╡ 025fcabc-1551-11eb-2cde-5fd2c0fec94c
vecvec = [[1,2], [3,4]]

# ╔═╡ 6353634e-1563-11eb-2f2a-71e769950104
length(vecvec)

# ╔═╡ b4789786-1558-11eb-3e82-5d5241e0ca60
for i in 1:length(vecvec)
	vcat(vecvec[i]',vecvec[i+1]')
	i++
end

# ╔═╡ a7d6027e-1563-11eb-3b22-572fce405432
b .= vecvec[1]'

# ╔═╡ 3f7eebf6-1564-11eb-2495-e173d364c343
vcat(vecvec[1]',vecvec[2]')

# ╔═╡ 1b74ce58-156a-11eb-0956-ed420da2e7d9
reduce(hcat, vecvec)'
